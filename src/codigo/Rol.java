...
import java.util.Random;
	...
	PJugador aragorn = new PJugador("Aragorn", dado(3,100), dado(2,12), dado(1,6));
	PJugador legolas = new PJugador("Legolas", dado(3,100), dado(2,12), dado(1,6));
	PJugador gimli = new PJugador("Gimli", dado(3,100), dado(2,12), dado(1,6));
